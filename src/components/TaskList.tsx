  ...
  if (tasks.length === 0) {
    return (
      <div className="text-center py-10">
        ...
        <p className="text-muted-foreground text-sm">No tasks found. Add one above!</p>
      </div>
    );
  }
            ...
            <CardContent className="flex items-center gap-3 py-3.5">
              {showCheckbox ? (
                <label className="relative flex items-center cursor-pointer shrink-0">
                  ...
                  {isCompleted ? (
                    ...
                    <div className="w-6 h-6 rounded-full border-2 border-muted-foreground/30 flex items-center justify-center transition-all duration-200 hover:border-emerald-400 peer-active:scale-90">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex flex-wrap gap-2 mt-1">
                  ...
                  {task.status === 'in_progress' && (
                    <span className="text-[11px] text-amber-600 dark:text-amber-300 bg-amber-100 dark:bg-amber-900/50 px-2 py-0.5 rounded-full font-medium">
                      In Progress
                    </span>
                  )}
                  {task.status === 'pending' && (
                  ...
                  {task.status === 'postponed' && (
                    <span className="text-[11px] text-purple-500 dark:text-purple-300 bg-purple-50 dark:bg-purple-900/50 px-2 py-0.5 rounded-full">
